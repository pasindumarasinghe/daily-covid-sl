...
const fetchData = async () => {
    try {
        ...
        last_updated.textContent = response.data.update_date_time;
        new_cases.textContent = response.data.local_new_cases;
        deaths.textContent = response.data.local_new_deaths;
    } catch (e) {
